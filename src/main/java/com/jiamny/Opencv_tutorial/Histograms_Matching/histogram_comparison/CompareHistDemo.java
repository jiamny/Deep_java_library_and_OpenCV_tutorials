package com.jiamny.Opencv_tutorial.Histograms_Matching.histogram_comparison;
...
public class CompareHistDemo {
    ...
    public static void main(String[] args) {
        String[] ags = {"data/opencv/pic2.png", "data/opencv/pic4.png", "data/opencv/pic5.png"};
        new CompareHist().run(ags);
    }
}
