package com.jiamny.Opencv_tutorial.ImgProc.tutorial_template_matching;
...
class MatchTemplateDemoRun implements ChangeListener {
    ...
    private void createJFrame() {
        ...
        labelTable.put(Integer.valueOf(0), new JLabel("0 - SQDIFF"));
        labelTable.put(Integer.valueOf(1), new JLabel("1 - SQDIFF NORMED"));
        labelTable.put(Integer.valueOf(2), new JLabel("2 - TM CCORR"));
        labelTable.put(Integer.valueOf(3), new JLabel("3 - TM CCORR NORMED"));
        labelTable.put(Integer.valueOf(4), new JLabel("4 - TM COEFF"));
        labelTable.put(Integer.valueOf(5), new JLabel("5 - TM COEFF NORMED : (Method)"));
...
public class MatchTemplateDemo {
    public static void main(String[] args) {
        ...
        // run code
        new MatchTemplateDemoRun().run(ags);
    }
}
