package com.jiamny.Opencv_tutorial.features2D.feature_flann_matcher;
...
class SURFFLANNMatching {
    public void run(String[] args) {
        String filename1 = args.length > 1 ? args[0] : "data/opencv/box.png";
        String filename2 = args.length > 1 ? args[1] : "data/opencv/box_in_scene.png";
