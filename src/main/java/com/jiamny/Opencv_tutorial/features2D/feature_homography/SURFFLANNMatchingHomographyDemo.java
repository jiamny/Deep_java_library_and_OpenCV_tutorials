package com.jiamny.Opencv_tutorial.features2D.feature_homography;
...
class SURFFLANNMatchingHomography {
    public void run(String[] args) {
        String filenameObject = args.length > 1 ? args[0] : "data/opencv/box.png";
        String filenameScene = args.length > 1 ? args[1] : "data/opencv/box_in_scene.png";
