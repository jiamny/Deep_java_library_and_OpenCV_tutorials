package com.jiamny.Opencv_tutorial.features2D.Homography;
...
public class PanoramaStitchingRotatingCamera {
    ...
    public static void main(String[] args) {
        String[] ag = {"data/opencv/left01.jpg", "data/opencv/right01.jpg"};
        new PanoramaStitchingRotatingCameraRun().basicPanoramaStitching(ag);
    }
}
