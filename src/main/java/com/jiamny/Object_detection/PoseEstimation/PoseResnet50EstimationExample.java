...
import com.jiamny.Object_detection.PoseEstimation.util.ImageUtils;
import com.jiamny.Object_detection.PoseEstimation.util.PersonDetection;
import com.jiamny.Object_detection.PoseEstimation.util.PoseResnet50Estimation;
...
public final class PoseResnet50EstimationExample {
  ...
  public static void main(String[] args) throws IOException, ModelException, TranslateException {
    ...
    for (DetectedObjects.DetectedObject person : persons) {
      ...
      ImageUtils.saveImage(subImg, "person-resnet50_" + index++ + ".png", "output");
      logger.info("{}", joints);
    ...
    ImageUtils.saveImage(image, "pose-resnet50-estimation.png", "output");
