package com.jiamny.Object_detection.PoseEstimation.util;
...
public final class PoseResnet50Estimation {
  ...
  public PoseResnet50Estimation() {}

  public static void main(String[] args) throws IOException, ModelException, TranslateException {
    Path imageFile = Paths.get("data/images/pedestrian.png");
    Image img = ImageFactory.getInstance().fromFile(imageFile);

    Joints detections = new PoseResnet50Estimation().predict(img);
  ...
  public Joints predict(Image img) throws IOException, ModelException, TranslateException {
    ...
    Criteria<Image, Joints> criteria =
        Criteria.builder()
            ...
            .optModelPath(Paths.get("models/pose_estimation/simple_pose_resnet50_v1b.zip"))
