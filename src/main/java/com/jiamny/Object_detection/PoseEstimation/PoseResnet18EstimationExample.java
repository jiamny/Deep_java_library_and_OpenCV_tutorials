...
import com.jiamny.Object_detection.PoseEstimation.util.PoseResnet18Estimation;
...
public final class PoseResnet18EstimationExample {
  ...
  public static void main(String[] args) throws IOException, ModelException, TranslateException {
    ...
    for (DetectedObjects.DetectedObject person : persons) {
      ...
      ImageUtils.saveImage(subImg, "person-resnet18_" + index++ + ".png", "output");
      logger.info("{}", joints);
    ...
    ImageUtils.saveImage(image, "pose-resnet18-estimation.png", "output");
