package com.jiamny.Object_detection.DNN_Classification;
...
public class DnnOpenCV {
    ...
    private static final String MODEL_PATH = "src/main/java/com/jiamny/Object_detection/DNN_Classification/models/pytorch_mobilenet.onnx";
